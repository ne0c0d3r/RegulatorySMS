...
class HTML2PDF_parsingCss
{
    ...
    */
    ...
    public function save()
    {
     ...
     /**
     * cancel a level in the CSS history
     *
     * @access public
     */
    ...
    public function convertBackground($css, &$value)
    {
        ...
        if (preg_match($text, $css, $match)) {
            ...
            // cancel if from the css properties
    ...
    public function readStyle(&$html)
    {
        ...
        // extract the link tags, and cancel them in the html code
...
// @TODO correction on url in absolute on a local css content
        ...
        // extract the style tags des tags style, and cancel them in the html code
