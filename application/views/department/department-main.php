              ...
              <div class="table-wrapper">
                <div class="col-md-12 rmv-all-margin rmv-all-padding std-height border-bottom  margin-bottom3">
                  <table class="table table-striped table-hover rmv-all-margin">
                    <tr>
                      <th class="width250">Department Short Name</th>
                      <th>Description</th>
                    </tr>
                ...
                <div class="text-center paging-wrapper" >
                  <ul id="" class="pagination-table pagination-sm rmv-all-margin font8" data-count="<?php echo count($deptData) ?>" data-module="department" data-limit="20"></ul>
                </div>
